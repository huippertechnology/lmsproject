            ...
            {getPropertyArray(overviewSection).map(
               (stat: any, index: number) => {
                  return (
                     <Card
                        key={`element-${index}`}
                        className="bg-secondary-100er relative rounded-3xl border-none px-6 py-10 !shadow-none md:py-12"
                        style={{
                           backgroundColor: getColorWithOpacity(
                              stat.bg_color,
                              1,
                           ),
                           color: getColorWithOpacity(stat.text_color, 1),
                        }}
                     >
                        <img
                           src={stat.image}
                        ...
                        <h3 className="mt-8 text-3xl font-semibold md:text-4xl">
                           {stat.count}
                        </h3>
