...
function RadioGroupItem({
  ...
  change = true,
  ...props
}: React.ComponentProps<typeof RadioGroupPrimitive.Item> & { change?: boolean }) {
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        ...
        change ? "text-primary" : "text-zinc-900 dark:text-zinc-50",
        className
      )}
      {...props}
    >
      ...
      >
        <CircleIcon className={cn(
          ...
          change ? "fill-primary" : "fill-zinc-900 dark:fill-zinc-50"
        )} />
      </RadioGroupPrimitive.Indicator>
    </RadioGroupPrimitive.Item>
  )
