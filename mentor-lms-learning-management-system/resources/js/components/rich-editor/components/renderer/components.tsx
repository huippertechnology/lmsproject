...
export const components: Partial<Components> = {
   ...
   img: ({ src, alt, style, width, height, marginLeft, marginRight }: any) => {
      // Extract width from inline style if present
      const imgStyle = style || {};
      const finalWidth = imgStyle.width || width;

      // Combine styles
      const combinedStyle = {
         width: imgStyle.width || finalWidth,
         maxWidth: '100%',
         height: 'auto',
         marginLeft: marginLeft || imgStyle.marginLeft || 'auto',
         marginRight: marginRight || imgStyle.marginRight || 'auto',
      };
