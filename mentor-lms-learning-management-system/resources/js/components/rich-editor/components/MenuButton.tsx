...
const MenuButton = React.forwardRef<HTMLButtonElement, MenuButtonProps>(
   (
      ...
      const renderIcon = useMemo(
         () =>
            icon ? (
               <Icon name={icon} className="rte-button-icon text-inherit" />
            ) : null,
         [icon],
      );
      ...
      const renderButton = (
         <Button
            ...
            type={buttonType}
            variant="ghost"
            className={clsx('rte-menu__button !px-2.5', buttonClass)}
            style={buttonStyle}
      ...
      const renderContent = tooltipContent ? (
         <Tooltip
            ...
            options={{
               collisionBoundary: contentElement.current?.parentElement,
            }}
         >
            {renderButton}
         </Tooltip>
