...
/**
* @see \Modules\Billing\Http\Controllers\Payout\PayoutController::settings
...
const PayoutController = { index, store, destroy, settings, update, request, history, checkout }
