...
/**
* @see \App\Http\Controllers\ChunkedUploadController::uploadChunk
* @see app/Http/Controllers/ChunkedUploadController.php:99
* @route '/dashboard/uploads/chunked/{id}/chunk'
*/
export const uploadChunk = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/dashboard/uploads/chunked/{id}/chunk'
*/
uploadChunk.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
...
* @route '/dashboard/uploads/chunked/{id}/chunk'
*/
uploadChunk.post = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: uploadChunk.url(args, options),
    method: 'post',
})
...
* @route '/dashboard/uploads/chunked/{id}/chunk'
*/
const uploadChunkForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: uploadChunk.url(args, options),
    method: 'post',
})
...
* @route '/dashboard/uploads/chunked/{id}/chunk'
*/
uploadChunkForm.post = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: uploadChunk.url(args, options),
    method: 'post',
})
...
const ChunkedUploadController = { initialize, uploadChunk, complete, status, abort }
