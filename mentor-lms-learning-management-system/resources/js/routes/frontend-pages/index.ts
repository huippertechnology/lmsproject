...
/**
* @see \Modules\Frontend\Http\Controllers\PageTranslationController::translations
* @see Modules/Frontend/app/Http/Controllers/PageTranslationController.php:15
* @route '/editor/{project}/{page}/translations/{locale}'
*/
export const translations = (args: { project: number | { id: number }, page: number | { id: number }, locale: string | number } | [project: number | { id: number }, page: number | { id: number }, locale: string | number ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/editor/{project}/{page}/translations/{locale}'
*/
translations.url = (args: { project: number | { id: number }, page: number | { id: number }, locale: string | number } | [project: number | { id: number }, page: number | { id: number }, locale: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            project: args[0],
            page: args[1],
...
* @route '/editor/{project}/{page}/translations/{locale}'
*/
translations.get = (args: { project: number | { id: number }, page: number | { id: number }, locale: string | number } | [project: number | { id: number }, page: number | { id: number }, locale: string | number ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: translations.url(args, options),
    method: 'get',
})
...
* @route '/editor/{project}/{page}/translations/{locale}'
*/
translations.head = (args: { project: number | { id: number }, page: number | { id: number }, locale: string | number } | [project: number | { id: number }, page: number | { id: number }, locale: string | number ], options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: translations.url(args, options),
    method: 'head',
})
...
* @route '/editor/{project}/{page}/translations/{locale}'
*/
const translationsForm = (args: { project: number | { id: number }, page: number | { id: number }, locale: string | number } | [project: number | { id: number }, page: number | { id: number }, locale: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/editor/{project}/{page}/translations/{locale}'
*/
translationsForm.get = (args: { project: number | { id: number }, page: number | { id: number }, locale: string | number } | [project: number | { id: number }, page: number | { id: number }, locale: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: translations.url(args, options),
    method: 'get',
})
...
* @route '/editor/{project}/{page}/translations/{locale}'
*/
translationsForm.head = (args: { project: number | { id: number }, page: number | { id: number }, locale: string | number } | [project: number | { id: number }, page: number | { id: number }, locale: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
