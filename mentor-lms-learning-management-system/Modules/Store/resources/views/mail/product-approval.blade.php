...
<body>
   ...
   @if ($status === 'approved')
      ...
      <p style="margin-bottom: 1.5em;">
         Your product "{{ $product->title }}" has been approved and is now live on our
         platform.
      </p>
   ...
   @else
      <h2 style="font-size: 1.25em; font-weight: 600; margin: 1.5em 0 1em;">
         Product Approval Request Update: {{ ucfirst($status) }}
      </h2>

      <p style="margin-bottom: 1em;">
         Your product "{{ $product->title }}" status has been updated to:
   ...
   @if ($status === 'approved')
      <p style="margin: 1.5em 0;">
         Students can now purchase your product. Promote it to reach more customers!
      </p>
   @endif
