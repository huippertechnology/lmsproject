...
} from '@/routes/product-category-child';
...
const Index = (props: ProductCategoriesIndexProps) => {
                     ...
                     <div className="space-y-4">
                        ...
                        <div className="space-y-1">
                           ...
                           <p className="text-sm leading-relaxed text-muted-foreground">
                              Products without a category are moved here
                              automatically. This category cannot be deleted.
                           </p>
                        </div>
                     </div>
                  </Card>
                                          ...
                                          routes={[
                                             {
                                                ...
                                                message: `The sub category "${child.title}" will be deleted and their products will be moved to it's parent category.`,
                                             },
                                          ]}
                                          component={
                                             <AddCategoryChild
