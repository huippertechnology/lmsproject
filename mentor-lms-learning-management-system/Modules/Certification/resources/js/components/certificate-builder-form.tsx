...
import { store, update } from '@/routes/certificate/templates';
import { Form } from '@inertiajs/react';
import { Save } from 'lucide-react';
import { useState } from 'react';
import CertificatePreview from './certificate-preview';

const CertificateBuilderForm = ({
   template,
}: {
   ...
   const [name, setName] = useState<string>(
      template?.name || 'My Certificate Template',
   );
               ...
               <div className="space-y-6">
                  <Card className="py-6">
                     <CardHeader>
                        ...
                        <CardDescription>
                           Set the template name and activation status
                        </CardDescription>
                     </CardHeader>
                  ...
                  <Card className="py-6">
                     <CardHeader>
                        ...
                        <CardDescription>
                           Upload your institution or course logo
                        </CardDescription>
                     </CardHeader>
                     <CardContent className="space-y-4">
                        <div className="space-y-2">
                  ...
                  <Card className="py-6">
                     <CardHeader>
                        ...
                        <CardDescription>
                           Customize the certificate color scheme
                        </CardDescription>
                     </CardHeader>
                     <CardContent className="space-y-4">
                  ...
                  <Card className="py-6">
                     <CardHeader>
                        ...
                        <CardDescription>
                           Choose the font style for your certificate
                        </CardDescription>
                     </CardHeader>
                     <CardContent>
                        <div className="space-y-2">
                  ...
                  <Card className="py-6">
                     <CardHeader>
                        ...
                        <CardDescription>
                           Customize the text content of your certificate
                        </CardDescription>
                     </CardHeader>
                     <CardContent className="space-y-4">
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                           ...
                           <Textarea
                              id="descriptionText"
                              name="template_data[descriptionText]"
                        ...
                        <div className="space-y-2">
                           <Label htmlFor="completionText">
                              Completion Text
                           </Label>
                           <Input
                              id="completionText"
                              name="template_data[completionText]"
