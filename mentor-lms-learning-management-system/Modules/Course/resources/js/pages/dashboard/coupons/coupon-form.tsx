...
import { store, update } from '@/routes/course-coupons';
import { Form, useForm } from '@inertiajs/react';
import { Shuffle } from 'lucide-react';
import { useRef, useState } from 'react';

const GLOBAL_COURSE_VALUE = 'global';
               ...
               transform={(formData) => ({
                  ...
                  valid_to:
                     typeof formData.valid_to === 'string' && formData.valid_to
                        ...
                        : formData.valid_to,
                  course_id:
                     formData.course_id === GLOBAL_COURSE_VALUE
                        ? ''
                        : formData.course_id,
               })}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                           ...
                           <div className="col-span-2">
                              ...
                              >
                                 ...
                                 <SelectContent>
                                    <SelectItem value={GLOBAL_COURSE_VALUE}>
                                       All Courses (global coupon)
                                    </SelectItem>
                                    {courses.map((c) => (
                                       <SelectItem
                                          key={c.id}
