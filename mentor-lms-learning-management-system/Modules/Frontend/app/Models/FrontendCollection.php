...
class FrontendCollection extends Model
{
    ...
    /**
     * Match public course listing cards: average rating, review count, total lesson duration.
     */
    protected function applyCourseListAggregates(Builder $query): void
    {
    ...
    public function getBestData()
    {
        ...
        $this->applyCourseListAggregates($query);
