   ...
   return (
      <EditorSection className="py-20">
         <EditorContainer className="relative">
            ...
            <EditorDiv className="pointer-events-none absolute top-1/2 left-1/2 h-[1000px] w-[1000px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(97,95,255,0.45)_0%,transparent_70%)] opacity-30 content-['']"></EditorDiv>
         </EditorContainer>
      </EditorSection>
   );
};
