...
import TiptapRenderer from '@/components/rich-editor/renderer';
...
const Index = () => {
   ...
   const handleSubmit = (e: FormEvent) => {
      ...
      post(payments.offline.submit.url());
   };
               ...
               <Card className="overflow-hidden shadow-sm">
                  ...
                  <div className="bg-blue-500 p-6 text-white">
                     ...
                     <p className="text-blue-100">
                        Please complete the payment and submit your transaction
                        details below
                     </p>
                  </div>
                  ...
                  <CardContent className="space-y-6 p-6">
                     {/* Order Summary */}
                     <Card className="border bg-gray-50 p-4 px-0">
                        ...
                        <Alert className="border-yellow-200 bg-yellow-50">
                           ...
                           <AlertDescription>
                              ...
                              <TiptapRenderer
                                 ...
                                 className="![--rte-bg:transparent] [&_.ProseMirror]:!py-0 [&_.rte-editor\_\_container]:!px-0"
                              />
                           </AlertDescription>
                        </Alert>
                     )}
                           ...
                           <form onSubmit={handleSubmit} className="space-y-4">
                              ...
                              <Alert className="border-blue-200 bg-blue-50">
                                 ...
                                 <AlertDescription className="text-sm text-blue-800">
                                    ...
                                    <p>
                                       Your enrollment will be activated once
                                       our team verifies your payment. This
                                       usually takes 1-2 business days. You will
                              ...
                              <div className="flex gap-3 pt-4">
                                 ...
                                 <Button
                                    ...
                                    className="gap-2"
                                 >
                                    <a href={payments.offline.cancel.url()}>
