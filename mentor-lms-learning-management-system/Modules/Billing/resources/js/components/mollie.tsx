...
const Mollie = ({ payment, type }: MollieProps) => {
                  ...
                  <div>
                     ...
                     <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                           ...
                           <Input
                              name="test_api_key"
                              defaultValue={payment.fields.test_api_key ?? ''}
                        ...
                        <div>
                           ...
                           <Input
                              name="live_api_key"
                              defaultValue={payment.fields.live_api_key ?? ''}
